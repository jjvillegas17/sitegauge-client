...
class DeleteUser extends Component {
    ...
    delete = (e) => {
        ...
        axios.post(`https://sitegauge.io/api/admin/delete`,
            {
                                                ...
                                                <tr key={user.id}>
                                                    <td className="collapsing">
                                                        <div className="ui toggle checkbox" >
                                                            <input type="checkbox" onClick={ () => this.addUserToDelete(user.id) }/> <label></label>
                                                        </div>
                                                    </td>
                                    ...
                                    </tbody>
                                    {
                                        ...
                                        <tfoot className="full-width">
                                            <tr>
                                              <td colSpan="3">
                                                <Modal
                                                    trigger={<button className="negative ui button" onClick={this.handleOpen}>Delete Users</button>}
                                                    open={this.state.modalOpen}   
                                                    onClose={this.handleClose}
                                                    basic
                                                    size='small'
                                                  >
                                                    <Header icon='archive' content='Delete these users?' />
                                                    <Modal.Content>
                                                      <h3>Are you sure you want to delete the selected users?</h3>
                                                    </Modal.Content>
                                                    <Modal.Actions>
